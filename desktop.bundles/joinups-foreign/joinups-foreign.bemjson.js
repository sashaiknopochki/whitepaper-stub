module.exports = {
	...
	content: [
	 {
		 tag: 'a',
		 attrs: { href: 'https://kassa.yandex.ru' },
		 block: 'logo-yandex-checkout', /* сделать выравнивание */
		 /* mods: { align: 'center' }, */
		 mix: { block: 'decorator', mods: { 'indent-t': 'xxxxl', 'indent-b': 'xxxxl' } },
	 },
										 ...
										 content: [
											 {
												 ...
												 content: [
													 ...
													 },
													 {
														 ...
														 {
															 tag: 'a',
													 		 attrs: { href: 'https://money.yandex.ru/doc.xml?id=523050' },
															 block: 'text',
...

{
	...
	content: [{
		tag: 'a',
		attrs: { href: 'https://money.yandex.ru/about.xml' },
		block: 'text',
